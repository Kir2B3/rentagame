...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: JeuVideo::class, mappedBy: 'proprietaire')]
    ...
    public function removeJeuVideo(JeuVideo $jeuVideo): static
    {
        if ($this->jeuVideos->removeElement($jeuVideo)) {
            ...
            if ($jeuVideo->getProprietaire() === $this) {
                $jeuVideo->setProprietaire(null);
            }
        }
